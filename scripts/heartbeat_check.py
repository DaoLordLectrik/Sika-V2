...
# Add parent directory to sys.path so we can import scripts modules
# This makes both "python scripts/run_signal_check.py" and "python -m scripts.run_signal_check" work
